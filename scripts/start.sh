...
export AVTR1_IDLE_NOISE_ALPHA="${AVTR1_IDLE_NOISE_ALPHA:-8.0}"
export AVTR1_IDLE_NOISE_TRUNC_Z="${AVTR1_IDLE_NOISE_TRUNC_Z:-0.65}"
...
export AVTR1_IDLE_BREATH_POSE_DEGREES="${AVTR1_IDLE_BREATH_POSE_DEGREES:-0.38}"
export AVTR1_IDLE_BREATH_YAW_RATIO="${AVTR1_IDLE_BREATH_YAW_RATIO:-0.32}"
export AVTR1_IDLE_BREATH_ROLL_RATIO="${AVTR1_IDLE_BREATH_ROLL_RATIO:--0.14}"
export AVTR1_IDLE_BREATH_PRIMARY_SECONDS="${AVTR1_IDLE_BREATH_PRIMARY_SECONDS:-4.4}"
