...
export AVTR1_IDLE_BLINK_ENABLED="${AVTR1_IDLE_BLINK_ENABLED:-1}"
export AVTR1_IDLE_BLINK_MIN_SECONDS="${AVTR1_IDLE_BLINK_MIN_SECONDS:-3.0}"
export AVTR1_IDLE_BLINK_MAX_SECONDS="${AVTR1_IDLE_BLINK_MAX_SECONDS:-7.0}"
export AVTR1_IDLE_BLINK_STRENGTH="${AVTR1_IDLE_BLINK_STRENGTH:-1.5}"
