...
export INDEXTTS_PLAY_RESERVOIR_SECONDS="${INDEXTTS_PLAY_RESERVOIR_SECONDS:-0.32}"
export INDEXTTS_MAX_TEXT_TOKENS_PER_SEGMENT="${INDEXTTS_MAX_TEXT_TOKENS_PER_SEGMENT:-28}"
...
export AVATAR_TEE_FINISH_HOLD_MS="${AVATAR_TEE_FINISH_HOLD_MS:-8000}"
...
export SMART_SEARCH_TIMEOUT_SECONDS="${SMART_SEARCH_TIMEOUT_SECONDS:-12}"
export SMART_SEARCH_EVIDENCE_BUDGET_SECONDS="${SMART_SEARCH_EVIDENCE_BUDGET_SECONDS:-8}"
export SMART_SEARCH_CACHE_SECONDS="${SMART_SEARCH_CACHE_SECONDS:-180}"
export SMART_SEARCH_COOLDOWN_SECONDS="${SMART_SEARCH_COOLDOWN_SECONDS:-20}"
...
export AVTR1_SPEECH_START_BUFFER_MS="${AVTR1_SPEECH_START_BUFFER_MS:-400}"
...
export AVTR1_IDLE_EXPRESSION_MIN_SECONDS="${AVTR1_IDLE_EXPRESSION_MIN_SECONDS:-2.0}"
export AVTR1_IDLE_EXPRESSION_MAX_SECONDS="${AVTR1_IDLE_EXPRESSION_MAX_SECONDS:-4.5}"
...
start_bg s2s "$RUN/s2s.pid" "$LOG/s2s.log" \
  env LD_LIBRARY_PATH="$S2S_LD_LIBRARY_PATH" \
      ...
      INDEXTTS_NUM_BEAMS="$INDEXTTS_NUM_BEAMS" \
