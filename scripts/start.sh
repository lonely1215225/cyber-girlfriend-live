...
export AVTR1_IDLE_NOISE_TRUNC_Z="${AVTR1_IDLE_NOISE_TRUNC_Z:-0.82}"
...
export AVTR1_IDLE_BREATH_POSE_DEGREES="${AVTR1_IDLE_BREATH_POSE_DEGREES:-0.48}"
export AVTR1_IDLE_BREATH_YAW_RATIO="${AVTR1_IDLE_BREATH_YAW_RATIO:-0.48}"
export AVTR1_IDLE_BREATH_ROLL_RATIO="${AVTR1_IDLE_BREATH_ROLL_RATIO:--0.22}"
