...
export AVTR1_IDLE_NOISE_ALPHA="${AVTR1_IDLE_NOISE_ALPHA:-6.0}"
export AVTR1_IDLE_NOISE_TRUNC_Z="${AVTR1_IDLE_NOISE_TRUNC_Z:-0.45}"
...
export AVTR1_BLINK_MIN_SECONDS="${AVTR1_BLINK_MIN_SECONDS:-${AVTR1_IDLE_BLINK_MIN_SECONDS:-2.6}}"
export AVTR1_BLINK_MAX_SECONDS="${AVTR1_BLINK_MAX_SECONDS:-${AVTR1_IDLE_BLINK_MAX_SECONDS:-7.2}}"
export AVTR1_BLINK_STRENGTH="${AVTR1_BLINK_STRENGTH:-${AVTR1_IDLE_BLINK_STRENGTH:-1.45}}"
export AVTR1_BLINK_SPEECH_INTERVAL_SCALE="${AVTR1_BLINK_SPEECH_INTERVAL_SCALE:-0.72}"
export AVTR1_BLINK_DOUBLE_PROBABILITY="${AVTR1_BLINK_DOUBLE_PROBABILITY:-0.10}"
export AVTR1_BLINK_PARTIAL_PROBABILITY="${AVTR1_BLINK_PARTIAL_PROBABILITY:-0.16}"
export AVTR1_IDLE_BREATH_ENABLED="${AVTR1_IDLE_BREATH_ENABLED:-1}"
export AVTR1_IDLE_BREATH_POSE_DEGREES="${AVTR1_IDLE_BREATH_POSE_DEGREES:-0.14}"
